...
<%
    Proprietaire[] list=(Proprietaire[])request.getAttribute("list");
%>
<body>
    <header>
    ...
    <div class="container">
            ...
            <% } else { %>
                ...
                <% for (int i=0; i!=list.length; i++) { %>
                    <tr>
                        ...
                        <td><%= list[i].getNom() %></td>
                        <td><%= list[i].getCoordonnees() %></td>
                        <td><a href="FormProprietaire?id=<%= list[i].getId() %>" class="btn btn-success">Edit</a></td>
                        <td><a href="Proprietaire?mod=d&id=<%= list[i].getId() %>" class="btn btn-danger">Delete</a></td>
                    </tr>
                <% } %>
            <% } %>
        </table>
        ...
        <% if (session.getAttribute("user")!=null) { %>
            <a href="FormProprietaire" class="nav-link" id="more">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path
