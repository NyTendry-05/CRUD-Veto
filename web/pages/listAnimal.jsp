            ...
            <% Animal[] list=(Animal[])request.getAttribute("list"); %>
                ...
                <body>
                    <header>
                        ...
                        <ul class="nav-list">
                            ...
                            <% if (session.getAttribute("user")!=null) { %>
                                <li>
                                    <a href="<%= request.getContextPath() %>/Login?mod=logout" class="nav-link">
                    ...
                    <div class="container">
                            ...
                            <% if (session.getAttribute("user")==null) { %>
                                ...
                                <% for (int i=0; i!=list.length; i++) { %>
                                    <tr>
                                        ...
                                        <td>
                                            <%= list[i].getIdProprietaire() %>
                                        </td>
                                        <td>
                                            <%= list[i].getProprietaire().getNom() %>
                                        </td>
                                    </tr>
                                    <% } %>
                                        <% } else { %>
                                            ...
                                            <% for (int i=0; i!=list.length; i++) { %>
                                                <tr>
                                                    ...
                                                    <td><a href="FormAnimal?id=<%= list[i].getId() %>"
                                                            class="btn btn-success">Edit</a></td>
                                                    <td><a href="Animal?mod=d&id=<%= list[i].getId() %>"
                        ...
                        <% if (session.getAttribute("user")!=null) { %>
                            <a href="FormAnimal" class="nav-link" id="more">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path
